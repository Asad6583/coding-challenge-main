...
class HomeController extends Controller
{
    ...
    {
        $this->middleware('auth')->except('getNetworkConnections');
    }
    ...
    public function getNetworkConnections(Request $request,$id)
    {
        ...
        return response()->json(['sent_requests'=>$sendRequests,'received_requests'=>$receivedRequests,'connections'=> $connections,'suggestions'=> $suggestions , 'type'=>$type]);
    }
}
